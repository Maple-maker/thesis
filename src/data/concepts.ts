...
const FOUNDATIONAL: Concept[] = [
  ...
  },
  {
    ...
    short: "Assets that may hold value when prices rise.",
    body: "An inflation hedge is something investors hope will keep purchasing power when the cost of living climbs, often TIPS (inflation-linked bonds), commodities, real estate, or sometimes dividend growers. Nothing hedges perfectly: each sleeve has its own risks (rates, demand cycles, concentration).",
    whyItMatters: "If inflation runs hotter than your cash and bond yields, your real wealth shrinks even when account balances look flat. Hedges are about matching the risk you're worried about, not chasing every headline.",
    related: ["inflation", "fed-rate", "diversification"],
  ...
  },
  {
    ...
    tier: "intermediate",
    term: "Dry powder",
    short: "Cash or near-cash kept ready to deploy.",
    body: "Dry powder is money held in cash, money-market funds, or very short-term instruments so you can buy when opportunities appear, dips, rebalances, or new positions. Funds and CEOs use the term; individuals do the same with an emergency fund or staging cash before investing.",
    whyItMatters: "Dry powder reduces forced selling in downturns and lets you act when prices dislocate. The tradeoff is opportunity cost, cash usually lags stocks over long periods, and inflation erodes idle dollars.",
    related: ["diversification", "risk-vs-return", "what-is-etf"],
    nextConcept: "dollar-cost-averaging",
  },
  {
    id: "diversification",
    tier: "foundational",
  ...
  },
  {
    ...
    tier: "foundational",
    term: "Bonds",
    short: "Loans you make to governments or companies, they pay you interest.",
    body: "A bond is an IOU. You lend money; the issuer promises to pay interest (the coupon) and return principal at maturity. US Treasuries are considered very safe; corporate bonds pay more but carry default risk. When interest rates rise, existing bond prices usually fall, an important relationship for investors.",
    whyItMatters: "Bonds stabilize many portfolios and fund retirements through income. They also move when the Fed changes rates, which ripples into stocks and housing.",
    related: ["interest-rate", "fed-rate", "inflation"],
    nextConcept: "fed-rate",
  },
  {
    id: "bitcoin",
    tier: "foundational",
    term: "Bitcoin",
    short: "Digital money on a public ledger, scarce, volatile, not backed by cash flows.",
    body: "Bitcoin is a decentralized network that tracks ownership on a blockchain. New coins are issued on a fixed schedule until a cap of 21 million. It has no earnings or dividends, price is driven by adoption, liquidity, regulation, and sentiment. Many treat it as a speculative sleeve, not a replacement for an emergency fund.",
    whyItMatters: "Crypto can dominate headlines and portfolio risk. Size any position to what you can lose entirely and understand custody (exchange vs self-custody).",
  ...
  },
  {
    ...
    tier: "foundational",
    term: "Interest rate",
    short: "The cost of borrowing money, or the reward for saving it.",
    body: "An interest rate is the percentage a lender charges you to borrow money, or the percentage a bank pays you for keeping your savings with them. If you take out a $1,000 loan at 5% annual interest, you will owe $1,050 after one year. If you put $1,000 in a savings account earning 2%, the bank pays you $20. The rate you pay as a borrower is almost always higher than the rate you earn as a saver, that spread is how banks make money.",
    whyItMatters: "Interest rates affect nearly every financial decision, from whether you should pay down debt or invest, to how much house you can afford. Even small differences in rates compound into large dollar amounts over time. Understanding which side of interest you are on (borrower or saver) is fundamental to managing your money.",
    related: ["compound-interest", "credit-score", "fed-rate", "inflation"],
  },
];

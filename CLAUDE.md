...
1. **`docs/current-slice.md`** — only implement what this file specifies.
2. **`AGENTS.md`** — stack, paths, conventions.
3. **`.cursor/rules/`** — product principles (educational, thesis-first onboarding).
